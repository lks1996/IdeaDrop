...
ENTRYPOINT ["sh", "-c", "\
  if [ \"$APP_RUN_MODE\" = \"lambda\" ]; then \
    ...
    exec java -cp /app/unpacked/BOOT-INF/classes:/app/unpacked/BOOT-INF/lib/*:/app/unpacked/META-INF com.amazonaws.services.lambda.runtime.api.client.AWSLambda com.ideaDrop.Common.ScheduledJobHandler; \
  else \
